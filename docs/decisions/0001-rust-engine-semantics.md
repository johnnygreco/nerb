...
cases. The sweep gates order-tens performance as well: the 32-entity raw scan must stay under 0.01s and the 32-to-2
entity scan-time ratio must stay under 40x.
